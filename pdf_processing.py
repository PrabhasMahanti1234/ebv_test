    ...
    try:
        ...
        for drug in drug_table:
            enriched_record = {
                ...
                "drug_requirements": drug.get("drug_requirements"),
                "page_number": drug.get("page_number"),
                "state_name": state_name,
                "coverage_status": "Covered",  # Default
                "ndc_code": None,
                "jcode": None,
                "is_prior_authorization_required": detect_prior_authorization(drug.get("drug_requirements")),
                "is_step_therapy_required": detect_step_therapy(drug.get("drug_requirements")),
